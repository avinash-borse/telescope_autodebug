...
class InstallCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $envLines = [
            ...
            'AUTODEBUG_AI_PROVIDER=ollama # openai, anthropic, google, ollama',
            '',
            '# AI Credentials (Provide only for your chosen provider)',
            'AUTODEBUG_OPENAI_API_KEY=',
            'AUTODEBUG_ANTHROPIC_API_KEY=',
            'AUTODEBUG_GOOGLE_API_KEY=',
